...
!  GitHub.com/MathieuandSpheroidalWaveFunctions/Mathieu. Especially see
!  the readme file, example input and output files and a relevant journal
!  article.
!
...
!  described. (Note that a subroutine version of matfcn is available
!  where the input parameters and output function values are passed
...
5       kindd=8
        kindq=16
!
!  set the minimum desired accuracy minacc to 10 for double
!  precision arithmetic and to 15 for quadruple arithmetic.
!  Minacc for quadruple precision can be changed if desired.
!  See the readme file for information about changing minacc.
!
...
!
        call main (lnum,cm,q,icq,isq,ioprad,iopang,minacc,izxi,x1,z, &
                   arg1,darg,narg,maxd,maxj,maxlp,maxn,maxp,maxk, &
                   maxkbp,ndec,nex,ngau,kindd,kindq)
!
        end
!
!
!
        subroutine main (lnum,cm,q,icq,isq,ioprad,iopang,minacc,izxi,x1, &
                         z,arg1,darg,narg,maxd,maxj,maxlp,maxn,maxp, &
                         maxk,maxkbp,ndec,nex,ngau,kindd,kindq)
!
...
!  real(knd) scalars
        real(knd) api,arg1,a01,asubl,b12,bsubl,cm,cepio2,cedpio2,ce0, &
                  darg,dec,eigaval,eigbval,eigavalp,eigbvalp,eiga1, &
                  eiga2,eiga3,eiga4,eiga5,eigb1,eigb2,eigb3,eigb4,eigb5, &
                  esa,esb,gamma,m1botc,m1bots,mc1c,mc1dc,mc2c,mc2dc, &
                  mc3c,mc3dc,ms1c,ms1dc,ms2c,ms2dc,ms3c,ms3dc,m3bot,pi, &
                  q,rl,sed0,sepio2,sedpio2,sgna,sgnb,wroncc,wroncs, &
                  wront,xi,xb,x1,z
!
